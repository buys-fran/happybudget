                                    ...
                                    <table width="95%">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-left"><a class="accordion-toggle btn btn-primary" data-toggle="collapse" href="#collapseIncome"><i class="icon-list icon-white"></i> Income</a>
                                                </td>
                                ...
                                <div id="collapseIncome" class="accordion-body collapse">
                                    <div class="accordion-inner">
                                        <table class="table table-bordered table-condensed table-hover table-striped">
                                            ...
                                            <td>
                                                <a >
                                                    <button class="btn btn-success btn-mini" type="button"><i class="icon-plus icon-white"></i></button>
                                                </a>
                                                Salary
                                            </td>
                                            ...
                                            <td class="text-right" width="5%">
                                                <a >
                                                    <button class="btn btn-danger btn-mini" type="button"><i class="icon-minus icon-white"></i></button>
                                                </a>
                                            </td>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="text-right" width="20%"><div class="text-right">R1,000,000.00</div></td>
                                                    <td class="text-right" width="20%"><div class="text-right">R1,000.00</div></td>
                                                    <td class="text-right" width="20%"><div class="text-right">R1,000.00</div></td>
                                                </tr>
                                            </tbody> 
                                        </table>
                                    ...
                                    <table width="95%">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-left"><a class="accordion-toggle btn btn-primary" data-toggle="collapse" href="#collapseExpenses"><i class="icon-list icon-white"></i> Expenses</a>
                                                </td>
                                                <td class="text-right" width="25%"><strong>R1,000,024.52</strong></td>   
                                            </tr>
                                        </tbody> 
