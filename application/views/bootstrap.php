...
<html lang="en">
    <head>
        ...
        <link href="../assets/app/css/bootstrap-responsive.css" rel="stylesheet">
    ...
    ================================================== --><!-- Placed at the end of the document so the pages load faster -->
        <script src="../../assets/app/js/jquery-1.10.0.js"></script> 
        <script src="../../assets/app/js/bootstrap.js"></script>
